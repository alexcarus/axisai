...
export default defineConfig({
    ...
    "/": [
      ...
      },
      {
        ...
        items: [
          ...
          { text: "FAQ", link: "/faq" },
          { text: "Team & About", link: "/about" },
        ],
      },
    ],
  },
  socials: [
    { icon: "x", link: "https://x.com/axismyai" },
    { icon: "github", link: "https://github.com/alexcarus/axisai" },
  ],
  ...
  topNav: [
    ...
    { text: "GitHub", link: "https://github.com/alexcarus/axisai" },
  ],
});
