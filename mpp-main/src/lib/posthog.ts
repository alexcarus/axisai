...
export const AnalyticsEvents = {
  ...
  // AXIS AI — Proof-of-AI-Work mining widget
  MINE_WALLET_GENERATED: "axis.mine.wallet_generated",
  MINE_STARTED: "axis.mine.started",
  MINE_STOPPED: "axis.mine.stopped",
  MINE_BLOCK_FOUND: "axis.mine.block_found",
  MINE_WORK_TYPE_SELECTED: "axis.mine.work_type_selected",
} as const;
